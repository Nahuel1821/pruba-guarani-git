...
class pagelet_info_curso extends pagelet
{
    ...
    function prepare()
    {
        ...
        switch ($this->estado) {
            case self::INICIAL:
                ...
                break;
            // seleccioné un curso que no estoy inscripto
            case self::CURSO_SELECCIONADO:
                $this->prepare_curso_seleccionado();
                break;

            // seleccioné un curso que no estoy inscripto y hubo error de controles
            case self::ERROR_CURSO_SELECCIONADO:
                //$this->prepare_error_materia_seleccionada();
                break;

            // estoy inscripto a un curso pero quiero reinscribirme en otra comisión
    ...
    protected function prepare_inicial()
    {
        ...
        foreach($inscripciones as $key => $inscripcion) {
            ...
            //Si termino el dictado de la comisión borro la inscripción de la misma
    ...
    protected function get_comision_inscripta_info($comisiones_inscriptas, $id_comision)
    {
        ...
        throw new error_guarani("Se está buscando la comision $id_comision en la lista de comisiones inscriptas y no existe");
    }
